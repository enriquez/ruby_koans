...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # "send" is commonly used name for a method.  __send__ provides an alternative.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # We can do amazing things like ActiveRecord's dynamic methods like find_by_first_name
  end
